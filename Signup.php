...
<html lang="en">
  ...
  <script>
    ...
    chatbotId: "NbtVX-ejeRKIMxPHx3wg2",
        ...
        <section class="text-gray-600 body-font relative">
            <div class="container px-5 py-24 mx-auto">
              <div class="flex flex-col text-center w-full mb-12">
                ...
                <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Welcome To Sign Up Page.</p>
              </div>
              <div class="lg:w-1/2 md:w-2/3 mx-auto">
                <div class="flex flex-wrap -m-2">
                  ...
                  <div class="p-2 w-full">
                    <!---<a href="index.html">-->
                    <button class="flex mx-auto text-white bg-blue-500 border-0 py-2 px-8 focus:outline-none hover:bg-blue-600 rounded text-lg"  name="submit">Sign Up</button>
                  </div></a>
                  <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                    <span class="inline-flex">
                      <a href="Login.html" class="ml-4 text-blue-500">Login</a>
                    </span>
                  </div>
                </div>
              </div>
...
if (isset($_POST['submit'])) {
    ...
    if ($password !== $confirm_password) {
        ...
        $add = mysqli_query($conn, "INSERT INTO registration (email, password) VALUES ('$email', '$password')");
